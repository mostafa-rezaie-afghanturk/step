...
class CampusController extends Controller
{
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'header' => 'Social Media Address 2',
                'accessor' => 'social_media_address_2',
                'visibility' => false,
                'type' => 'string',
                'validation' => 'nullable|url|max:255',
                'context' => ['show', 'edit', 'create'],
            ...
            [
                'header' => 'Social Media Address 3',
                'accessor' => 'social_media_address_3',
                'visibility' => false,
                'type' => 'string',
                'validation' => 'nullable|url|max:255',
                'context' => ['show', 'edit', 'create'],
    ...
    protected function getFields($country = null)
    {
        return [
            ...
            [
                ...
                'type' => 'string',
                'required' => false,
                'default' => $country?->social_media_address_3,
            ],
        ];
    }
