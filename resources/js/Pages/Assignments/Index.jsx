...
import SingleShow from '@/Pages/Transfers/SingleShow';
    ...
    <>
      <AuthenticatedLayout>
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold">{t('asset-assignments')}</h1>
          </div>
          <div>
        ...
        <div className="rounded-lg bg-white">
          <DataTable
            permissionModule="asset-assignments"
            columns={tableColumns}
            url={route('asset-assignments.datatable')}
            primaryKey={'asset_assignment_id'}
