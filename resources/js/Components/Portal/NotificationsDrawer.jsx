...
const NotificationDrawer = () => {
    ...
    return (
        ...
        >
            <DrawerTrigger className="py-1 px-2 hover:bg-gray-100 focus:outline-none rounded-md inline-flex items-center gap-x-2">
            ...
            >
                <DrawerHeader>
                    ...
                    <DrawerDescription>
                        <div
                            ref={containerRef}
                            className="h-[calc(100vh-170px)] w-full overflow-auto "
                        >
