...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\EducationalMaterial>
 */
class EducationalMaterialFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'asset_code' => 'EM' . str_pad($assetCodeCounter++, 6, '0', STR_PAD_LEFT),
            'tmv_code' => $this->faker->optional()->bothify('TMV-####'),
            'group' => $this->faker->randomElement(['Science', 'Chemistry', 'Physics', 'Biology', 'Mathematics', 'Literature']),
            'subgroup' => $this->faker->word(),
            'status' => $this->faker->randomElement(['Very good', 'Good', 'Maintenance required', 'Unusable']),
            ...
            'price' => $this->faker->optional()->randomFloat(2, 5, 5000),
            ...
            'related_level' => $this->faker->optional()->randomElement([
                'Preschool', 'Primary School', 'Middle School', 'High School', 'University'
            ]),
            'photo' => $this->faker->optional()->imageUrl(),
            'lifespan' => $this->faker->optional()->numberBetween(1, 15),
            'start_date' => $this->faker->optional()->date(),
            'warranty_start' => $this->faker->optional()->date(),
            'warranty_end' => $this->faker->optional()->date(),
            'warranty_cert' => $this->faker->optional()->bothify('WC-####'),
            ...
            'calibration_required' => $this->faker->boolean(30),
